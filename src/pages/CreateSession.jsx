...
export default function CreateSession() {
  ...
  return (
    <div className="min-h-screen bg-theme-muted text-theme-dark flex flex-col relative overflow-x-hidden dark:bg-zinc-950">
      ...
      <header className="relative z-20 pt-3 sm:pt-6 px-4 sm:px-6 w-full max-w-7xl mx-auto flex items-center justify-end shrink-0">
        <button
          ...
          className="w-8 h-8 sm:w-10 sm:h-10 bg-theme-surface border-[2px] md:border-[3px] border-theme-dark text-theme-dark hover:bg-theme-primary hover:text-theme-white transition-all duration-150 retro-shadow cursor-pointer flex items-center justify-center shrink-0 rounded-full dark:bg-zinc-900"
        >
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden opacity-60 dark:opacity-20">
          ...
          {currentStep === 2 && (
            <section className="flex flex-col justify-between h-full flex-1">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-theme-surface rounded-[12px] border-[1px] border-theme-dark p-4 sm:p-6 flex flex-col h-[280px] sm:h-[320px] max-w-xl mx-auto w-full dark:bg-zinc-900">
                      ...
                      draftTasks.map((taskText, index) => (
                        <div key={index} className="flex items-center gap-2 w-full">
                          <input
                            ...
                            className="flex-1 bg-theme-surface text-theme-dark border-[2px] border-theme-dark p-2 font-pressstart text-[8px] sm:text-[9px] focus:outline-none focus:bg-[#FFFFFF] dark:bg-zinc-800 placeholder-theme-dark/40 transition-colors"
                          />
                          <button
                            type="button"
                            onClick={() => deleteDraftTaskRow(index)}
                            title="Delete Task"
                            className="w-6 h-6 bg-theme-danger border-[2px] border-theme-dark flex items-center justify-center text-white font-pressstart text-[10px] hover:brightness-110 active:scale-90 cursor-pointer shrink-0"
                          >
                            ✕
                          </button>
                        </div>
                  ...
                  <button
                    ...
                    className="self-start w-auto bg-theme-safe text-theme-dark border-[2px] border-theme-dark px-4 py-2 font-pressstart text-[9px] sm:text-[10px] cursor-pointer transition-all duration-150 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#3D2013] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_#3D2013] flex items-center justify-center gap-1.5 mt-3 shrink-0"
                  >
                    + Add Task
                  </button>
                </div>
            ...
            <section className="flex flex-col justify-between h-full flex-1">
              <div className="space-y-4 sm:space-y-6">
                <div className="text-center mb-6 sm:mb-10">
                  ...
                  <p className="font-pressstart text-[9px] sm:text-xs text-theme-dark/80 mt-2">
                    Today’s study plan strategy analyzed by Kitsu AI.
                  </p>
                </div>
                ...
                {selectedTechnique !== 'recommended' && (
                  <div className="pt-2 max-w-2xl mx-auto w-full">
                    ...
                    <input
                      ...
                      className="w-full sm:w-1/2 bg-theme-surface rounded-[8px] border-[1px] border-theme-dark px-3.5 py-2 font-pressstart text-[9px] sm:text-[10px] text-theme-dark outline-none dark:bg-zinc-800"
                    />
                  </div>
                )}
              </div>
          ...
          {currentStep === 4 && (
            <section className="flex flex-col justify-between h-full flex-1">
              <div className="space-y-4 sm:space-y-6 max-w-2xl mx-auto w-full">
                ...
                <div className="bg-theme-surface rounded-[12px] border-[1px] border-theme-dark p-4 sm:p-6 space-y-4 text-xs sm:text-sm dark:bg-zinc-900">
                  {/* WORK TYPE REVIEW */}
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="bg-theme-surface rounded-[12px] border-[1px] border-theme-dark p-4 sm:p-5 text-center flex flex-col items-center justify-center gap-3 dark:bg-zinc-800">
                    ...
                    <ul className="space-y-1.5 max-h-[140px] overflow-y-auto pr-1 font-pixel text-[13px] sm:text-[16px] text-theme-dark">
                      {draftTasks
                        ...
                        .map((task, idx) => (
                          <li
                            key={idx}
                            className="bg-theme-surface border border-theme-dark px-2.5 py-1.5 font-bold text-theme-dark flex items-center gap-2 dark:bg-zinc-800"
                          >
